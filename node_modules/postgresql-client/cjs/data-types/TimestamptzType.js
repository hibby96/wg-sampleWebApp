...
const parse_datetime_1 = require("../util/parse-datetime");
const timeShift = 946684800000;
const timeMul = 4294967296;
exports.TimestamptzType = {
    name: 'timestamptz',
    oid: definitions_1.DataTypeOIDs.timestamptz,
    jsType: 'Date',
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString &&
            options.fetchAsString.includes(definitions_1.DataTypeOIDs.timestamptz);
    ...
    encodeBinary(buf, v, options) {
        if (typeof v === 'string')
            v = (0, parse_datetime_1.parseDateTime)(v, true, true, options.utcDates);
        if (v === Infinity) {
    ...
    parseText(v, options) {
        const d = (0, parse_datetime_1.parseDateTime)(v, true, true, options.utcDates);
        if (options.fetchAsString && options.fetchAsString.includes(definitions_1.DataTypeOIDs.timestamptz)) {
...
exports.ArrayTimestamptzType = {
    ...exports.TimestamptzType,
    name: '_timestamptz',
    oid: definitions_1.DataTypeOIDs._timestamptz,
    elementsOID: definitions_1.DataTypeOIDs.timestamptz
};
