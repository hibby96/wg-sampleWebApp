...
exports.DateType = {
    name: 'date',
    oid: definitions_1.DataTypeOIDs.date,
    jsType: 'Date',
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString && options.fetchAsString.includes(definitions_1.DataTypeOIDs.date);
    ...
    encodeBinary(buf, v, options) {
        if (typeof v === 'string')
            v = (0, parse_datetime_1.parseDateTime)(v, false, false, options.utcDates);
        if (v === Infinity) {
    ...
    parseText(v, options) {
        ...
        if (fetchAsString)
            return v;
        return (0, parse_datetime_1.parseDateTime)(v, false, false, options.utcDates);
    },
    isType(v) {
...
exports.ArrayDateType = {
    ...exports.DateType,
    name: '_date',
    oid: definitions_1.DataTypeOIDs._date,
    elementsOID: definitions_1.DataTypeOIDs.date
};
