...
exports.TimestampType = {
    name: 'timestamp',
    oid: definitions_1.DataTypeOIDs.timestamp,
    jsType: 'Date',
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString &&
            options.fetchAsString.includes(definitions_1.DataTypeOIDs.timestamp);
    ...
    encodeBinary(buf, v, options) {
        if (typeof v === 'string')
            v = (0, parse_datetime_1.parseDateTime)(v, true, false, options.utcDates);
        if (v === Infinity) {
    ...
    parseText(v, options) {
        if (options.fetchAsString && options.fetchAsString.includes(definitions_1.DataTypeOIDs.timestamp))
            return v;
        return (0, parse_datetime_1.parseDateTime)(v, true, false, options.utcDates);
    },
    isType(v) {
...
exports.ArrayTimestampType = {
    ...exports.TimestampType,
    name: '_timestamp',
    oid: definitions_1.DataTypeOIDs._timestamp,
    elementsOID: definitions_1.DataTypeOIDs.timestamp
};
