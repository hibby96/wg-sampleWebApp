...
const parse_time_1 = require("../util/parse-time");
const timeMul = 4294967296;
exports.TimeType = {
    name: 'time',
    oid: definitions_1.DataTypeOIDs.time,
    jsType: 'string',
    parseBinary(v, options) {
        const fetchAsString = options.fetchAsString &&
            options.fetchAsString.includes(definitions_1.DataTypeOIDs.time);
    ...
    encodeBinary(buf, v, options) {
        if (typeof v === 'string')
            v = (0, parse_time_1.parseTime)(v, false, options.utcDates);
    ...
    parseText(v, options) {
        if (options.fetchAsString && options.fetchAsString.includes(definitions_1.DataTypeOIDs.time))
            return v;
        return (0, parse_time_1.parseTime)(v, false, options.utcDates);
    },
    isType(v) {
...
exports.ArrayTimeType = {
    ...exports.TimeType,
    name: '_time',
    oid: definitions_1.DataTypeOIDs._time,
    elementsOID: definitions_1.DataTypeOIDs.time
};
