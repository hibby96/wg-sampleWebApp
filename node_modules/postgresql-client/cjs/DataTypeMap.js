...
const JsonbType_1 = require("./data-types/JsonbType");
...
exports.GlobalTypeMap.register(JsonbType_1.JsonbType, JsonbType_1.ArrayJsonbType);
...
exports.GlobalTypeMap.register({ ...VarcharType_1.VarcharType, name: 'bpchar', oid: definitions_1.DataTypeOIDs.bpchar });
exports.GlobalTypeMap.register({
    ...VarcharType_1.ArrayVarcharType,
    name: '_bpchar',
    oid: definitions_1.DataTypeOIDs._bpchar,
    elementsOID: definitions_1.DataTypeOIDs.bpchar
});
exports.GlobalTypeMap.register({ ...VarcharType_1.VarcharType, name: 'name', oid: definitions_1.DataTypeOIDs.name });
exports.GlobalTypeMap.register({
    ...VarcharType_1.ArrayVarcharType,
    name: '_name',
    oid: definitions_1.DataTypeOIDs._name,
    elementsOID: definitions_1.DataTypeOIDs.name
});
exports.GlobalTypeMap.register({ ...VarcharType_1.VarcharType, name: 'text', oid: definitions_1.DataTypeOIDs.text });
exports.GlobalTypeMap.register({
    ...VarcharType_1.ArrayVarcharType,
    name: '_text',
    oid: definitions_1.DataTypeOIDs._text,
    elementsOID: definitions_1.DataTypeOIDs.text
});
exports.GlobalTypeMap.register({ ...VarcharType_1.VarcharType, name: 'xml', oid: definitions_1.DataTypeOIDs.xml });
exports.GlobalTypeMap.register({
    ...VarcharType_1.ArrayVarcharType,
    name: '_xml',
    oid: definitions_1.DataTypeOIDs._xml,
    elementsOID: definitions_1.DataTypeOIDs.xml
});
