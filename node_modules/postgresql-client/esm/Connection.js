...
import { ConnectionState, DataTypeOIDs } from './definitions';
...
export class Connection extends SafeEventEmitter {
    ...
    async query(sql, options) {
        ...
        const paramTypes = options?.params?.map(prm => prm instanceof BindParam ? prm.oid : typeMap.determine(prm) || DataTypeOIDs.varchar);
